...
lazy_static! {
    /// File suffix name and file media type one-to-one correspondence data
    pub static ref MIME_MAPPING: Vec<(&'static str, &'static str)> = vec![
