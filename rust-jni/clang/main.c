...
JNIEXPORT jclass JNICALL Java_CallJNI_findClass(JNIEnv *env, jclass _, jstring name)
{
...
JNIEXPORT jobject JNICALL Java_CallJNI_getSystemOut(JNIEnv *env, jclass _)
{
    ...
    jfieldID jfid_out = (*env)->GetStaticFieldID(env, jcls_System, "out", "Ljava/io/PrintStream;");
